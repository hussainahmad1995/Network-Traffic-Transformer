...
# print("This is the epoch training loss difference " + epoch_train_loss_df)
...
# print("This is the training loss difference" + train_loss_step_df)

val_loss_step_df = df[df["tag"] == "Val loss"]
val_loss_step_df.reset_index(inplace=True, drop=True)
# print(val_loss_step_df)

# print("Print epoch_train_loss_df_index" + str(epoch_train_loss_df.index))

# print(epoch_train_loss_df.index)
...
# #save figure
plt.savefig(fname = "training_loss_per_epoch")
# # plt.show()
...
# print("Print val loss step index" + str(val_loss_step_df.index))


# plt.savefig(fname = "value_loss_per_epoch")
# # plt.show()
